...
![alt text](https://github.com/Romerozabal/cpwalker-ros_simulation/blob/main/Physical_conections_cpwalker_exo_1.png "Figure 1. Physical connection to the robot.")
![alt text](https://github.com/Romerozabal/cpwalker-ros_simulation/blob/main/rosgraph_acquisitio_processing_control.png "Figure 2. ROS topics communication between the nodes.")
![alt text](https://github.com/Romerozabal/cpwalker-ros_simulation/blob/main/exo_model_node_1.png "Figure 3. ROS exo model node, subscribes to Vout and publish the angle of each joint.")
